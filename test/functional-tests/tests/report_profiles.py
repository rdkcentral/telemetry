...
data_with_grep_accumulate_timestamp = '{ "profiles": [ { "name": "TR_ACCUM", "hash": "Hash234", "value":{ "Description": "Accumulate_grep", "Version": "0.1", "Protocol": "HTTP", "EncodingType": "JSON", "ReportingInterval": 10, "TimeReference": "0001-01-01T00:00:00Z", "Parameter": [ { "type": "grep", "marker": "Load_Average", "search": "telemetry2_0", "logFile": "top_log.txt" }, { "type": "grep", "marker": "cpu_telemetry2_0", "search": "telemetry2_0", "logFile": "top_log.txt" }, { "type": "grep", "marker": "SYS_INFO_Accum_Time", "search": "identifier:", "logFile": "accum.log", "use": "accumulate", "reportTimestamp": "Unix-Epoch" }, {"type":"grep","marker":"SYS_INFO_Accum_No_Time","search":"CollectAndReport while","logFile":"telemetry2_0.txt.0","use":"accumulate","reportTimestamp":"Unix-Epoch"}, {"type":"grep","marker":"SYS_INFO_Accum_Alone","search":"reporting interval","logFile":"telemetry2_0.txt.0","use":"accumulate"} ], "HTTP": { "URL": "https://mockxconf:50051/dataLakeMock/", "Compression": "None", "Method": "POST", "RequestURIParameter": [ { "Name": "profileName", "Reference": "Profile.Name" }, { "Name": "reportVersion", "Reference": "Profile.Version" } ] }, "JSONEncoding": { "ReportFormat": "NameValuePair", "ReportTimestamp": "None" } }} ] }'

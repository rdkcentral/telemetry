...
typedef void (*T2EventMarkerListCallback)(const char *componentName,
                                          void **eventMarkerList);
...
typedef T2ERROR (*triggerReportOnCondtionCallBack)(const char *referenceName,

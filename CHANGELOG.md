...
#### [1.10.4](https://github.com/rdkcentral/telemetry/compare/1.10.3...1.10.4)

- RDKB-66418: Handle rbus method failure efficiently [`#423`](https://github.com/rdkcentral/telemetry/pull/423)

#### [1.10.3](https://github.com/rdkcentral/telemetry/compare/1.10.2...1.10.3)

> 4 September 2026

- RDKB-66724: Increased Retry for Trigger condition RBUS failure [`#422`](https://github.com/rdkcentral/telemetry/pull/422)
- Changelog updates for 1.10.3 release [`68d1320`](https://github.com/rdkcentral/telemetry/commit/68d1320ff3368103833d4e11f17ea74f36de3055)

#### [1.10.2](https://github.com/rdkcentral/telemetry/compare/1.10.1...1.10.2)

> 4 September 2026

- RDKC-16495: telemetry(DCMAGENT) async-subscribe to DCM Reloadconfig T2 - DCM [`#401`](https://github.com/rdkcentral/telemetry/pull/401)
- Changelog updates for 1.10.2 release [`e75c0fd`](https://github.com/rdkcentral/telemetry/commit/e75c0fd292793bb9b3f8112db7f34d4d2aa8a1d4)

#### [1.10.1](https://github.com/rdkcentral/telemetry/compare/1.10.0...1.10.1)

> 20 August 2026

- RDKB-65621: Propagate seek-map clearing across log-upload profiles [`#414`](https://github.com/rdkcentral/telemetry/pull/414)
- Changelog updates for 1.10.1 release [`69e45e0`](https://github.com/rdkcentral/telemetry/commit/69e45e00908743d90028bb67ddad22f78d7deb56)

#### [1.10.0](https://github.com/rdkcentral/telemetry/compare/1.9.9...1.10.0)

> 13 August 2026

- Fix the gaps in workflows to upload L1 test results to portal [`#407`](https://github.com/rdkcentral/telemetry/pull/407)
- RDKB-65730: Integrate Dynamic Table Support - MsgPack support and L2 tests [`#404`](https://github.com/rdkcentral/telemetry/pull/404)
- RDKB-65730: Integrate Dynamic Table Support - Build Time Disabled [`#396`](https://github.com/rdkcentral/telemetry/pull/396)
- RDKCOM-5614: RDKBDEV-3443 Add typed fields support for telemetry reporting [`#398`](https://github.com/rdkcentral/telemetry/pull/398)
- RDKEMW-18459 : Ensure Proper Synchronization across Logs Backup, Reboot Reason and Log Upload [`#385`](https://github.com/rdkcentral/telemetry/pull/385)
- RDKEMW-21242: Detect log rotation via inode tracking to prevent data loss when new log file grows past seek value [`#392`](https://github.com/rdkcentral/telemetry/pull/392)
- Update profile.c [`#377`](https://github.com/rdkcentral/telemetry/pull/377)
- RDKB-65487: Telemetry rdkcentral exposing comcast specific URL [`#386`](https://github.com/rdkcentral/telemetry/pull/386)
- RDKEMW-18410: Xconf thread should wait Indefinitely for the NTP indicator [`#372`](https://github.com/rdkcentral/telemetry/pull/372)
...
- Fix memory safety issues blocking PR-161 L1 tests [`#363`](https://github.com/rdkcentral/telemetry/pull/363)
- Resolve build error in telemetry [`#364`](https://github.com/rdkcentral/telemetry/pull/364)
- TELEMETRY-2: Dynamic telemetry markers for Dynamic Tables in Telemetry [`#161`](https://github.com/rdkcentral/telemetry/pull/161)
- RDKEMW-12350: Fix uninitialized missing error checks in timeZoneDST fallback path [`9de29ae`](https://github.com/rdkcentral/telemetry/commit/9de29aec28cce9641950380c05a9e31afd64b1a0)
- Changelog updates for 1.10.0 updates [`a3b7639`](https://github.com/rdkcentral/telemetry/commit/a3b7639177a7af39a2796c2ee911bd65f6f693b5)
- RDKEMW-21242: Skipping inode check for Previous Log data collection [`8b58ce8`](https://github.com/rdkcentral/telemetry/commit/8b58ce896dcdf4a7c80b7efa426aa33700efaa15)

#### [1.9.9](https://github.com/rdkcentral/telemetry/compare/1.9.8...1.9.9)

> 22 July 2026

- RDKEMW-18459 : Ensure Proper Synchronization across Logs Backup, Reboot Reason and Log Upload [`#385`](https://github.com/rdkcentral/telemetry/pull/385)
- Changelog updates for 1.9.9 release [`ff823cd`](https://github.com/rdkcentral/telemetry/commit/ff823cd555a2dcdffe439a183a70b1c655df3087)

#### [1.9.8](https://github.com/rdkcentral/telemetry/compare/1.9.7...1.9.8)

> 22 July 2026

- RDKEMW-21242: Skipping inode check for Previous Log data collection [`#399`](https://github.com/rdkcentral/telemetry/pull/399)
- Changelog updates for 1.9.8 release [`98e2b8e`](https://github.com/rdkcentral/telemetry/commit/98e2b8e89a031bd1cbc9c203e4203a8352cbcd6b)

#### [1.9.7](https://github.com/rdkcentral/telemetry/compare/1.9.6...1.9.7)

> 14 July 2026

- RDKEMW-21242: Detect log rotation via inode tracking to prevent data loss when new log file grows past seek value [`#393`](https://github.com/rdkcentral/telemetry/pull/393)
- Changelog updates for 1.9.7 release [`cf7bc62`](https://github.com/rdkcentral/telemetry/commit/cf7bc6280da774da261fc534cc023bca5fd7adc5)

#### [1.9.6](https://github.com/rdkcentral/telemetry/compare/1.9.5...1.9.6)

> 9 July 2026

- RDKEMW-12350: Fix uninitialized missing error checks in timeZoneDST fallback path [`#389`](https://github.com/rdkcentral/telemetry/pull/389)
- Changelog updates for 1.9.6 release [`1399fc3`](https://github.com/rdkcentral/telemetry/commit/1399fc337b3d49d143c749af1f05195dbe2b4131)
...
#### [1.7.2](https://github.com/rdkcentral/telemetry/compare/1.7.1...1.7.2)

> 10 December 2025

- RDKEMW-11275: L1 testcase updation for 0 value and empty value [`4a3f866`](https://github.com/rdkcentral/telemetry/commit/4a3f86622edfbb7404d9c84e8a75c035119fdac4)
- RDKEMW-11275: L1 testcase updation [`db39da5`](https://github.com/rdkcentral/telemetry/commit/db39da530553199a65fa40cf6ff22e082c136174)
- Skipping the reporting of grep marker if the value is empty [`e93f2d9`](https://github.com/rdkcentral/telemetry/commit/e93f2d9ec36c1c19ea5f8a02092cb3b1412d2a0c)
...
- Changelog updates for 1.7.1 release [`a937c74`](https://github.com/rdkcentral/telemetry/commit/a937c7466ee56d88bf551b5094013a6da9ec3880)
- As per legacy logic, absolute/split markers with 0 string value should not be reported [`ba0c1ab`](https://github.com/rdkcentral/telemetry/commit/ba0c1abf1eb11bfa9c288fc4daa358f6a5b1b5f5)

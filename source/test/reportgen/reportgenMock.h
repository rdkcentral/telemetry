...
public:
  ...
  virtual cJSON *cJSON_GetObjectItem(const cJSON *const object,
                                     const char *const string) = 0;
  ...
  virtual cJSON *cJSON_AddStringToObject(cJSON *const object,
                                         const char *const name,
                                         const char *const string) = 0;
  //      virtual cJSON_bool cJSON_AddItemToObject(cJSON *object, const char
  //      *string, cJSON *item) = 0;
  ...
  virtual int regexec(const regex_t *preg, const char *string, size_t nmatch,
                      regmatch_t pmatch[], int eflags) = 0;
...
public:
  ...
  MOCK_METHOD2(cJSON_GetObjectItem,
               cJSON *(const cJSON *const, const char *const));
  // MOCK_METHOD2(cJSON_AddItemToArray, cJSON_bool(cJSON *, cJSON *));
  MOCK_METHOD3(cJSON_AddStringToObject,
               cJSON *(cJSON *const, const char *const, const char *const));

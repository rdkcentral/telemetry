...
static void send_profile_update_signal(void)
{
    ...
    LOG_INFO("ProfileUpdate signal sent successfully (serial=%u)", serial);
    printf("\n[SIGNAL] ProfileUpdate sent (serial=%u)\n", serial);
    fflush(stdout);
}
...
static void* input_handler_thread(void* arg) {
    ...
    printf("\n╔════════════════════════════════════════╗\n");
    printf("║   D-Bus Test Server Running            ║\n");
    printf("╚════════════════════════════════════════╝\n");
    printf("\nCommands:\n");
...
int main(int argc, char *argv[]) {
    ...
    printf ("╔═══════════════════════════════════════════╗\n");
    printf ("║   D-Bus Test Server Starting              ║\n");
    printf ("╚═══════════════════════════════════════════╝\n");
    /* Initialize logging */
    ...
    LOG_INFO("Event Interface: %s", T2_DBUS_EVENT_INTERFACE_NAME);
    LOG_INFO("========================================");

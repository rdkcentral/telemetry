...
/*
 * the main struct in cosa_xxx_apis.h need includes this struct and realize all
 * functions.
 */
...
/*
 *  This struct is for creating entry context link in writable table when call
 * GetEntry()
 */
...
ANSC_STATUS
CosaSListPushEntryByInsNum(PSLIST_HEADER pListHead,
                           PCOSA_CONTEXT_LINK_OBJECT pCosaContext);

PCOSA_CONTEXT_LINK_OBJECT
CosaSListGetEntryByInsNum(PSLIST_HEADER pListHead, ULONG InstanceNumber);

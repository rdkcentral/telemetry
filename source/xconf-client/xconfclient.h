...
#define TR181_DEVICE_CURRENT_WAN_IFNAME                                        \
...
#define TR181_DEVICE_FW_VERSION                                                \

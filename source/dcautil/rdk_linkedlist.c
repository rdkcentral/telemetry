...
rdkList_t *rdk_list_add_node_before(rdkList_t *rdkListHndl, rdkList_t *sibling,
                                    void *pData) {
  rdkList_t *tmpHndl;
  tmpHndl = (rdkList_t *)malloc(sizeof(rdkList_t));
  if (!tmpHndl) {
  ...
  if (!rdkListHndl) {
    ...
    if (NULL != sibling)
      printf(
          "rdk_list_add_node_before(): sibling not NULL for an empty list\n");
  } else if (sibling) {
...
rdkList_t *rdk_list_find_node_custom(rdkList_t *rdkListHndl, void *pData,
                                     fnRDKListCustomCompare compareFunction) {
...
void rdk_list_foreach(rdkList_t *rdkListHndl,
                      fnRDKListCustomExecute executeFunction,
                      void *pUserActionData) {
...
void rdk_list_free_all_nodes_custom(rdkList_t *rdkListHndl,
                                    fnRDKListCustomFree freeFunction) {

...
void rbusMessage_FromBytes(rbusMessage *message, uint8_t const *buff,
                           uint32_t n);
...
rtError rbusMessage_SetBytes(rbusMessage message, uint8_t const *value,
                             uint32_t size);
rtError rbusMessage_GetBytes(rbusMessage message, uint8_t const **value,
                             uint32_t *size);

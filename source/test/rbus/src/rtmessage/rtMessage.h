 ...
 * @return rtError
 */
rtError rtMessage_Clone(rtMessage const message, rtMessage *copy);
 ...
 * argument of suggested_size, which will be used to allocate the memory on the
 *heap. If this is found to be insufficient, cJSON will realloc internally, but
 *if the application gets this right, costly realloc() calls can be avoided.
 * @param extract the data bytes from this message.
 * @param pointer to the byte sequence location
 ...
 * @return rtError
 **/
rtError rtMessage_ToByteArrayWithSize(rtMessage message, uint8_t **buff,
                                      uint32_t suggested_size, uint32_t *n);

/**
 * Free the buffer allocated by rtMessage_ToByteArray or
 *rtMessage_ToByteArrayWithSize
 * @param pointer to the byte sequence to free
 * @return rtError
 **/
rtError rtMessage_FreeByteArray(uint8_t *buff);
 ...
 * @return void
 **/
void rtMessage_SetString(rtMessage message, char const *name,
                         char const *value);
 ...
 * @return rtError
 **/
rtError rtMessage_AddString(rtMessage message, char const *name,
                            char const *value);
 ...
 * @return rtError
 **/
rtError rtMessage_AddBinaryData(rtMessage message, char const *name,
                                void const *ptr, const uint32_t size);
/**
 ...
 * @return rtError
 **/
rtError rtMessage_AddMessage(rtMessage m, char const *name,
                             rtMessage const item);
 ...
 * @return rtError
 **/
rtError rtMessage_GetArrayLength(rtMessage const m, char const *name,
                                 int32_t *length);
 ...
 * @return rtError
 **/
rtError rtMessage_GetStringItem(rtMessage const m, char const *name,
                                int32_t idx, char const **value);
 ...
 * @return rtError
 **/
rtError rtMessage_GetMessageItem(rtMessage const m, char const *name,
                                 int32_t idx, rtMessage *msg);
 ...
 * @return rtError
 **/
rtError rtMessage_SetMessage(rtMessage message, char const *name,
                             rtMessage item);
 ...
 * @return rtError
 **/
rtError rtMessage_GetString(rtMessage const m, char const *name,
                            char const **value);
/**
 ...
 * @return rtError
 **/
rtError rtMessage_GetBinaryData(rtMessage message, char const *name, void **ptr,
                                uint32_t *size);
 ...
 * @return rtError
 **/
rtError rtMessage_GetStringValue(rtMessage const m, char const *name,
                                 char *value, int n);
 ...
 * @return rtError
 **/
rtError rtMessage_GetDouble(rtMessage const m, char const *name, double *value);
 ...
 * @return rtError
 **/
rtError rtMessage_GetMessage(rtMessage const m, char const *name,
                             rtMessage *item);
 ...
 * @return rtError
 **/
rtError rtMessage_ToString(rtMessage m, char **s, uint32_t *n);
...
rtError rtMessage_SetBool(rtMessage const m, char const *name, bool b);

rtError rtMessage_GetBool(rtMessage const m, char const *name, bool *b);
 ...
 * @return rtError
 **/
rtError rtMessage_Retain(rtMessage m);

...
data_with_grep_accumulate_timestamp = '{ "profiles": [ { "name": "TR_ACCUM", "hash": "Hash234", "value":{ "Description": "Accumulate_grep", "Version": "0.1", "Protocol": "HTTP", "EncodingType": "JSON", "ReportingInterval": 10, "TimeReference": "0001-01-01T00:00:00Z", "Parameter": [ { "type": "grep", "marker": "SYS_INFO_Accum_Time", "search": "identifier:", "logFile": "accum.log", "use": "accumulate", "reportTimestamp": "Unix-Epoch" }, {"type":"grep","marker":"SYS_INFO_Accum","search":"filler ","logFile":"accum.log","use":"accumulate","reportTimestamp":"Unix-Epoch"} ], "HTTP": { "URL": "https://mockxconf:50051/dataLakeMock/", "Compression": "None", "Method": "POST", "RequestURIParameter": [ { "Name": "profileName", "Reference": "Profile.Name" }, { "Name": "reportVersion", "Reference": "Profile.Version" } ] }, "JSONEncoding": { "ReportFormat": "NameValuePair", "ReportTimestamp": "None" } }} ] }'

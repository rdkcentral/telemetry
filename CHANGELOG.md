...
#### [1.6.8v3](https://github.com/rdkcentral/telemetry/compare/1.6.8v2...1.6.8v3)

> 30 July 2026

- RDKEMW-21629: Detect log rotation via inode tracking to prevent data loss when new log file grows past seek value
 [`#402`](https://github.com/rdkcentral/telemetry/pull/402)

#### [1.6.8v2](https://github.com/rdkcentral/telemetry/compare/1.6.8v1...1.6.8v2)

> 20 May 2026

- RDKEMW-18410: Xconf thread should wait for the NTP indicator for network [`#370`](https://github.com/rdkcentral/telemetry/pull/370)

#### [1.6.8v1](https://github.com/rdkcentral/telemetry/compare/1.6.8...1.6.8v1)

> 22 April 2026

- RDKEMW-13448: Empty config file handling fix for telemetry2.0 [`#343`](https://github.com/rdkcentral/telemetry/pull/343)
- SERXIONE-8445/XIONE-18418: PREVIOUS_LOGS lookup failure fix for telemetry2.0 [`#343`](https://github.com/rdkcentral/telemetry/pull/343)

#### [1.6.8](https://github.com/rdkcentral/telemetry/compare/1.7.0...1.6.8)

- RDKB-62477:Clients related split markers with value as 0 after Upgrad… [`#215`](https://github.com/rdkcentral/telemetry/pull/215)
     Correcting the logical errors that is very specific to cherry pick errors to hotfix/1.6.5 branch 

#### [1.6.7](https://github.com/rdkcentral/telemetry/compare/1.6.6...1.6.7)

> 20 November 2025

- The release version 1.6.7 is a bad release and shall not be taken to any active branches
